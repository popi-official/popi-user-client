...
export default function SignUpScreen() {
  ...
  const handleAgeSnapPress = useCallback(
    (index: number) => {
      if (step !== 2) {
        return;
      }
  ...
  const handleGenderSnapPress = useCallback(
    (index: number) => {
      if (step !== 3) {
        return;
      }
            ...
            <S.InputSection>
              ...
              <S.InputWrapper>
                <S.SelectButton onPress={() => handleAgeSnapPress(0)}>
                  ...
                  {step === 2 && <S.ArrowIcon source={images.downArrow} />}
                </S.SelectButton>
              </S.InputWrapper>
            </S.InputSection>
          )}
            ...
            <S.InputSection>
              ...
              <S.InputWrapper>
                <S.SelectButton onPress={() => handleGenderSnapPress(0)}>
                  ...
                  {step === 3 && <S.ArrowIcon source={images.downArrow} />}
                </S.SelectButton>
              </S.InputWrapper>
            </S.InputSection>
          )}
